...
class mo_saml_options_enum_metadata_uploadMoSAML extends MoSAMLBasicEnum {
...
class mo_saml_contact_us_constants extends MoSAMLBasicEnum{
...
class mo_saml_demo_constants extends MoSAMLBasicEnum {
...
class mo_saml_account_setup_constants extends MoSAMLBasicEnum {
...
class mo_saml_settings_constants extends MoSAMLBasicEnum {
	const saml_message = 'mo_saml_message';
	const new_user = 'mo_is_new_user';
}

class mo_saml_customer_constants extends MoSAMLBasicEnum {
...
class mo_saml_messages extends MoSAMLBasicEnum {
