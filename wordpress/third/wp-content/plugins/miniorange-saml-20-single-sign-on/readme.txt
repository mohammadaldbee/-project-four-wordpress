...
Provides real time user-provisioning from your IDP to your WordPress using SCIM standard. You can refer to <a href="https://plugins.miniorange.com/wordpress-user-provisioning" target="_blank"> WordPress User Provisioning using SCIM </a> plugin.
